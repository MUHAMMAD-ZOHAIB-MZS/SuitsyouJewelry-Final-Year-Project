      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        <TouchableOpacity onPress={() => navigation.navigate('earring')}>
          <View style={styles.box}>
            <MaterialCommunityIcons name="diamond-stone" size={24} color="black" style={styles.myicon} />
        ...
        <TouchableOpacity onPress={() => navigation.navigate('bracelet')}>
          <View style={styles.box}>
            <MaterialCommunityIcons name="gold" size={24} color="black" style={styles.myicon} />
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ring')}>
          <View style={styles.box}>
            <MaterialCommunityIcons name="ring" size={24} color="black" style={styles.myicon} />
        ...
        <TouchableOpacity onPress={() => navigation.navigate('watches')}>
          <View style={styles.box}>
            <MaterialCommunityIcons name="watch" size={24} color="black" style={styles.myicon} />
