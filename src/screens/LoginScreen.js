...
const LoginScreen = ({navigation}) => {
  ...
  const handleLogin = () => {
              ...
              .catch((error) => {
                ...
                if(errorMessage == 'Firebase : The email address is budly formatted. (auth/invalid-email).'
                ){
  ...
  return (
    ...
    <AntDesign name="user" size={24} color={emailfocus===
...
fontWeight:"bold"}}>Sign ln</Text>
</TouchableOpacity>

<Text style={styles.forgotpassword} onPress={()=> navigation.navigate
('forgot')}> Forgot Password</Text>
