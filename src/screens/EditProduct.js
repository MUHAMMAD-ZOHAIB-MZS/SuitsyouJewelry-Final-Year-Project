...
import { necklace, earring, watches, bracelet, ring, chain } from '../globals/style';
...
const EditProduct = ({ navigation, route }) => {
  ...
  const updateCardData = () => {
    ...
    const updatedCardData = {
      ...carddata,
     Addonquantity: addonquantity, Jewelryquantity: quantity 
    };
  ...
  const increaseAddonQuantity = () => {
    setAddonQuantity((prevAddonQuantity) => (parseInt(prevAddonQuantity) + 1).toString());
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.container1}>
        <View style={styles.s1}>
          <Image source={{ uri: carddata.data.jewelryImageUrl }} style={styles.cardimgin} />
        </View>
        ...
        <View style={styles.s2}>
          ...
          {carddata.data.jewelryAddonPrice && (
            <View style={styles.container3}>
              ...
              <View style={styles.c3in}>
                ...
                <Text style={styles.text4}>Rs{carddata.data.jewelryAddonPrice}/-</Text>
              </View>
              <View style={incdecout}>
                <Text style={incdecbtn} onPress={increaseAddonQuantity}>
                  +
                </Text>
                <TextInput value={addonquantity} style={incdecinput} onChangeText={setAddonQuantity} />
          ...
          <View style={styles.container3}>
            ...
            <View style={incdecout}>
              ...
              <TextInput value={quantity} style={incdecinput} onChangeText={setQuantity} />
