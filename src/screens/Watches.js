...
import { colors ,watches } from '../globals/style';
...
const Watches = ({ navigation }) => {
  ...
  useEffect(() => {
    setWatchesData(jewelryData.filter((item) => item.jewelryType === 'watches'));
  }, [jewelryData]);
      ...
      <Text style={styles.descriptionText}>Description of Item</Text>
       <Text style={styles.text}>
        ...
        <View style={styles.cardslider}>
          <Cardslider title={'Watches Jewelry'} data={WatchesData} navigation={navigation} />
        </View>
      </ScrollView>
