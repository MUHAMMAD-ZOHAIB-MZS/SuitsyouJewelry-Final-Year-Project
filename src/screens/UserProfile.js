      ...
      {!edit && !passwordEdit && (
        <View style={styles.container}>
          ...
          <View style={styles.containerin}>
            <Text style={styles.head2}>Name: {userdata?.name || 'loading'}</Text>
            <Text style={styles.head2}>Email: {userdata?.email || 'loading'}</Text>
            <Text style={styles.head2}>Phone: {userdata?.phone || 'loading'}</Text>
          </View>
